...
- [ ] **CMD-01**: User can run `professor:new-topic` to start a new course on a topic
- [ ] **CMD-02**: User can run `professor:next` to advance to the next section
- [ ] **CMD-03**: User can run `professor:review` to review a completed section
- [ ] **CMD-04**: User can run `professor:done` to mark a section complete
- [ ] **CMD-05**: User can run `professor:hint` to receive a hint without the answer being revealed
- [ ] **CMD-06**: User can run `professor:stuck` to receive additional guidance when genuinely stuck
- [ ] **CMD-07**: User can run `professor:syllabus` to view the course outline
- [ ] **CMD-08**: User can run `professor:progress` to view learning progress
- [ ] **CMD-09**: User can run `professor:discuss` to open discussion on a concept
- [ ] **CMD-10**: User can run `professor:quiz` to run a quiz on the current topic
